...
const articleList = [
  {
    name: "Hvordan kan kommunene lykke...",
  ...
  {
    name: "Vil dere gjøre tiltak på riktig sted før...",
    text:
      "Gjør overvannstiltak på riktig sted Overvann er begrepet som beskriver overflateavrenning fra ",
    path: "/",
    import: article2,
    style: null
  },
...
const Section_1 = () => {
  const article = articleList.map((item, index) => (
    <NavLink key={index} className={item.style}>
      <div className="img">
